                ...
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            <!-- Left Side Image-->
                            <div class="col-lg-6">
                                <img src="{{ uploaded_asset(get_setting('seller_login_page_image')) }}" alt="{{ translate('Seller Login Page Image') }}" class="img-fit h-100" style="object-fit: contain !important;">
                            </div>
