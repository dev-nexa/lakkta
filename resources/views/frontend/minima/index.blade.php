...
<style>
    ...
    .car-categories-title:hover {
        ...
        /* إزاحة خفيفة للنص عند التمرير */
    }
</style>

@if (count($featured_categories) > 0)
<section class="car-categories-section mb-2 mb-md-3 mt-2 mt-md-3">
    <div class="container">
        <h3 class="text-center car-categories-title">
                    ...
                    <div class="swiper-slide">
                        <div class="category-card">
                            ...
                            <div class="category-overlay">
                                <a class="category-link text-white"
